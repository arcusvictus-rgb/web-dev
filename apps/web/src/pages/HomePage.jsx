              ...
              <div className="max-w-3xl">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    ...
                    <CallButton size="lg" variant="outline" className="rounded-xl border-2 border-white text-white hover:bg-white hover:text-black font-bold uppercase tracking-wider" />
                  </div>
                </motion.div>
              </div>
            </div>
              ...
              <div className="border-2 border-white p-12 md:p-16 text-center rounded-3xl">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-2xl mx-auto space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                    ...
                    <WhatsAppButton size="lg" variant="outline" className="rounded-xl border-2 border-white text-white hover:bg-white hover:text-black font-bold uppercase tracking-wider" />
                  </div>
                </motion.div>
              </div>
            </div>
